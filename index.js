...
client.on("messageCreate", async message => {
    ...
    await message.author.send({
        content: `**Vendetta** hakkınız \`${hak}\`! Başlatmak için aşağıdaki butona basın.\n[Botu Eklemek İçin Buraya Tıkla](https://discord.com/oauth2/authorize?client_id=1444720893548040223)  **Not:** Botun Rolunun Ustlerde Olduğundan Ve Yetkisi Olduğundan Emin Olunuz..`,
        components: [button]
    }).catch(() => {});
});
